...
namespace Drastic.Common.Forms.ViewModels
{
    /// <summary>
    ...
    public class FlyoutPageViewModel : BaseViewModel
    {
        ...
        public FlyoutPageViewModel(FlyoutPage page, List<MainMenuItem> menuItems, MainMenuItem footerMenu, IErrorHandler error, INavigationHandler navigation)
